...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { description: @network.description, name: @network.name, url_web: @network.url_web }
    end
  ...
  test "should update network" do
    put :update, id: @network, network: { description: @network.description, name: @network.name, url_web: @network.url_web }
    assert_redirected_to network_path(assigns(:network))
  end
